...
using ConsoleTables;
using Coverlet.Console.Framework.Logging;
using Coverlet.Core;
    ...
    class Program
    {
        static int Main(string[] args)
        {
            ...
            app.OnExecute(() =>
            {
                ...
                ThresholdStatistic dThresholdStat;

                if (thresholdStat.HasValue())
                {
                    Enum.TryParse(thresholdStat.Value(), out dThresholdStat);
                }
                else
                {
                    Enum.TryParse("minimum", out dThresholdStat);
                }
